...
if __name__ == "__main__":
    ...
    finetuned_model.compile(optimizer=SGD(lr=0.0001), loss='categorical_crossentropy', metrics=['accuracy'])
...
finetuned_model.save('/home/sounak/Desktop/resnet50_final.h5')
